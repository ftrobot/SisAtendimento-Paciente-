    ...
    private void btnCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCadastrarMouseClicked
        ...
        if (boxSexo.getSelectedItem().toString().equalsIgnoreCase("*sexo") || txtCPF.getText().isEmpty() || txtNome.getText().isEmpty() || txtRG.getText().isEmpty() || txtDNASC.getText().isEmpty()
            ...
            try {
                ...
                m.addMedico(Long.parseLong(txtCRM.getText().replace(".", "").replace(",", "")), Long.parseLong(txtCPF.getText().replace(".", "").replace("-", "")), Integer.parseInt(txtRG.getText().replace(".", "").replace("-", "")), txtNome.getText(), txtDNASC.getText(), txtEmail.getText(),
